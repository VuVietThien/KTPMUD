...
{
    partial class ToChucSanXuatConGiongManagementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblDiaChi=new Label(); txtDiaChi=new TextBox(); lblSDT=new Label(); txtSDT=new TextBox();
            lblEmail=new Label(); txtEmail=new TextBox(); lblMST=new Label(); txtMST=new TextBox();
            lblGPKD=new Label(); txtGPKD=new TextBox(); lblGhiChu=new Label(); txtGhiChu=new TextBox();
            ...
            lblTitle.Text="TỔ CHỨC SẢN XUẤT CON GIỐNG"; lblTitle.Font=new Font("Segoe UI",13,FontStyle.Bold);
            ...
            F(lblTen,txtTen,"Tên tổ chức *",10,5,280); F(lblLoaiHinh,txtLoaiHinh,"Loại hình",300,5,180);
            F(lblDiaChi,txtDiaChi,"Địa chỉ",490,5,390);
            F(lblSDT,txtSDT,"SĐT",10,68,130); F(lblEmail,txtEmail,"Email",150,68,220);
            F(lblMST,txtMST,"Mã số thuế",380,68,140); F(lblGPKD,txtGPKD,"GP KD",530,68,180);
            F(lblGhiChu,txtGhiChu,"Ghi chú",720,68,160);
            ...
            StartPosition=FormStartPosition.CenterScreen; Text="Tổ chức SX Con Giống"; Load+=Form_Load; ResumeLayout(false);
        }
        private Panel pnlHeader, pnlInput, pnlToolbar;
        private Label lblTitle, lblTen, lblLoaiHinh, lblDiaChi, lblSDT, lblEmail, lblMST, lblGPKD, lblGhiChu;
        private TextBox txtTen, txtLoaiHinh, txtDiaChi, txtSDT, txtEmail, txtMST, txtGPKD, txtGhiChu, txtTimKiem;
