...
{
    partial class GiongVatNuoiCamXuatKhauManagementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblLyDo=new Label(); txtLyDo=new TextBox(); chkNgay=new CheckBox();
            dtpNgayBanHanh=new DateTimePicker(); lblCoQuan=new Label(); txtCoQuan=new TextBox();
            ...
            lblTitle.Text="GIỐNG VẬT NUÔI CẤM XUẤT KHẨU"; lblTitle.Font=new Font("Segoe UI",13,FontStyle.Bold);
            ...
            F(lblCoQuan,txtCoQuan,"Cơ quan ban hành",430,5,280);

            chkNgay.Text="Ngày ban hành:"; chkNgay.Font=new Font("Segoe UI",9,FontStyle.Bold);
            chkNgay.Location=new Point(10,68); chkNgay.Size=new Size(130,20);
            chkNgay.CheckedChanged += (s,e) => dtpNgayBanHanh.Enabled = chkNgay.Checked;
            dtpNgayBanHanh.Location=new Point(145,65); dtpNgayBanHanh.Size=new Size(180,28);
            dtpNgayBanHanh.Font=new Font("Segoe UI",10); dtpNgayBanHanh.Enabled=false;
            pnlInput.Controls.AddRange(new Control[] { chkNgay, dtpNgayBanHanh });

            F(lblLyDo,txtLyDo,"Lý do cấm",335,65,360);
            F(lblGhiChu,txtGhiChu,"Ghi chú",10,95,760);
            ...
            AutoScaleDimensions=new SizeF(7F,15F); AutoScaleMode=AutoScaleMode.Font; ClientSize=new Size(1100,620);
            Controls.Add(dgv); Controls.Add(pnlToolbar); Controls.Add(pnlInput); Controls.Add(pnlHeader);
            StartPosition=FormStartPosition.CenterScreen; Text="Giống Vật Nuôi Cấm Xuất Khẩu"; Load+=Form_Load; ResumeLayout(false);
        }
        private Panel pnlHeader, pnlInput, pnlToolbar;
        private Label lblTitle, lblTen, lblLoai, lblLyDo, lblCoQuan, lblGhiChu;
        private TextBox txtTen, txtLoai, txtLyDo, txtCoQuan, txtGhiChu, txtTimKiem;
        private CheckBox chkNgay; private DateTimePicker dtpNgayBanHanh;
