...
{
    partial class CoSoKhaoNghiemManagementForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblTitle.Text="CƠ SỞ KHẢO NGHIỆM GIỐNG VẬT NUÔI"; lblTitle.Font=new Font("Segoe UI",13,FontStyle.Bold);
            ...
            F(lblTen,txtTen,"Tên cơ sở *",10,5,280); F(lblLoai,txtLoai,"Loại khảo nghiệm",300,5,200);
            F(lblDiaChi,txtDiaChi,"Địa chỉ",510,5,370);
            F(lblSDT,txtSDT,"SĐT",10,68,130); F(lblEmail,txtEmail,"Email",150,68,220);
            F(lblMST,txtMST,"Mã số thuế",380,68,140); F(lblGPKD,txtGPKD,"GP KD",530,68,200);
            F(lblGhiChu,txtGhiChu,"Ghi chú",740,68,150);
            ...
            StartPosition=FormStartPosition.CenterScreen; Text="Cơ sở Khảo Nghiệm"; Load+=Form_Load; ResumeLayout(false);
        }
        private Panel pnlHeader, pnlInput, pnlToolbar;
        private Label lblTitle, lblTen, lblLoai, lblDiaChi, lblSDT, lblEmail, lblMST, lblGPKD, lblGhiChu;
        private TextBox txtTen, txtLoai, txtDiaChi, txtSDT, txtEmail, txtMST, txtGPKD, txtGhiChu, txtTimKiem;
