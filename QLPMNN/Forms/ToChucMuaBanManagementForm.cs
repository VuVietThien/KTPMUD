...
{
    public partial class ToChucMuaBanManagementForm : Form
    {
        private int _selectedId = 0;
        public ToChucMuaBanManagementForm() { InitializeComponent(); }
        private void Form_Load(object sender, EventArgs e) => LoadData();

        private void LoadData()
        {
            dgv.DataSource = ToChucMuaBanService.GetAll();
            SetCommonHeaders();
        }
        ...
        private void SetCommonHeaders()
        {
            var map = new Dictionary<string, string> {
                ...
                ["CreatedDate"]="Ngày tạo",["IsActive"]="Hoạt động"
            };
        ...
        private ToChucMuaBan GetEntity() => new() {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            { MessageBox.Show("Vui lòng nhập Tên tổ chức!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning); return; }
            ToChucMuaBanService.Add(GetEntity());
            UserService.LogAccess(CurrentSession.CurrentUser!.UserID, $"Thêm TC Mua Bán: {txtTen.Text}");
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            ToChucMuaBanService.Update(GetEntity());
            UserService.LogAccess(CurrentSession.CurrentUser!.UserID, $"Sửa TC Mua Bán ID={_selectedId}");
            LoadData(); ClearInputs();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            ToChucMuaBanService.Delete(_selectedId);
            UserService.LogAccess(CurrentSession.CurrentUser!.UserID, $"Xóa TC Mua Bán ID={_selectedId}");
            LoadData(); ClearInputs();
        }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            dgv.DataSource = string.IsNullOrEmpty(kw) ? ToChucMuaBanService.GetAll() : ToChucMuaBanService.Search(kw);
            SetCommonHeaders();
        }
