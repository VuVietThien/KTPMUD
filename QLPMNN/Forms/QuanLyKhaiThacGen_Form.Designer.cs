...
{
    partial class QuanLyKhaiThacGen_Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblEmail = new Label(); txtEmail = new TextBox(); lblNguoiDaiDien = new Label(); txtNguoiDaiDien = new TextBox();
            ...
            lblTitle.Text = "QUẢN LÝ TỔ CHỨC KHAI THÁC GEN";
            ...
            AutoScaleDimensions=new SizeF(7F,15F); AutoScaleMode=AutoScaleMode.Font; ClientSize=new Size(1000,600);
            Controls.Add(dgv); Controls.Add(pnlToolbar); Controls.Add(pnlInput); Controls.Add(pnlHeader);
            StartPosition=FormStartPosition.CenterScreen; Text="Quản lý Khai thác Gen"; Load+=Form_Load; ResumeLayout(false);
        }
