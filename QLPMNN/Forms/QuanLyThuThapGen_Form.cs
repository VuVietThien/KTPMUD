...
{
    public partial class QuanLyThuThapGen_Form : Form
    {
        private string _selectedMa = "";
        private const string Table = "ToChucThuThapGen";
        private const string PK = "MaThuThap";

        public QuanLyThuThapGen_Form() { InitializeComponent(); }
        ...
        private void SetHeaders()
        {
            var map = new Dictionary<string, string> {
                ["MaThuThap"] = "Mã", ["TenToChuc"] = "Tên tổ chức",
        ...
        private void dgv_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            _selectedMa = row.Cells["MaThuThap"].Value?.ToString() ?? "";
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Vui lòng nhập Mã và Tên tổ chức!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            try
            {
                DatabaseConnection.ExecuteNonQuery(
                    $"INSERT INTO {Table} VALUES(@Ma,@Ten,@DC,@SDT,@Email,@NDD,@GhiChu)",
                    GetParams());
                UserService.LogAccess(CurrentSession.CurrentUser!.UserID, $"Thêm thu thập gen: {txtMa.Text}");
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            DatabaseConnection.ExecuteNonQuery(
                ...
                GetParams());
            UserService.LogAccess(CurrentSession.CurrentUser!.UserID, $"Sửa thu thập gen: {_selectedMa}");
            LoadData(); ClearInputs();
        }
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            UserService.LogAccess(CurrentSession.CurrentUser!.UserID, $"Xóa thu thập gen: {_selectedMa}");
            LoadData(); ClearInputs();
        }
        ...
        private void btnTimKiem_Click(object sender, EventArgs e)
        {
            ...
            dgv.DataSource = DatabaseConnection.ExecuteQuery(
                $"SELECT * FROM {Table} WHERE {PK} LIKE @kw OR TenToChuc LIKE @kw OR NguoiDaiDien LIKE @kw ORDER BY {PK}",
